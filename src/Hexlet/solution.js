...
const parse = (data) => {
    const args = data.slice(1)
        .reduce((acc, arg) => ({ acc, [getAttrName(arg)]: argDo[getAttrName(arg)](arg) }), { name: data[0], attributes: {}, body: '', children: [] });
    return buildNode.buildNode(args.name, args.attributes, args.body, args.children);
};
